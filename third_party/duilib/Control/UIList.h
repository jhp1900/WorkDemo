...
{
public:
    virtual CDuiString GetItemText(CControlUI* pList, int iItem, int iSubItem) = 0;
};
...
public:
	...
	//multil select list
	bool GetMultiArray(int &selectIndex, CStdValArray* &pMutilArray) const;
	bool RemoveMultiIndex(int index);
	void SetMultiArryEmpty();
	void SetCurSelectIndex(int index = -1);
